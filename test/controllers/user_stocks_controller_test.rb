...
class UserStocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_stock" do
    assert_difference('UserStock.count') do
      post user_stocks_url, params: { user_stock: { stock: @user_stock.stock, user_id: @user_stock.user_id } }
    end
  ...
  test "should update user_stock" do
    patch user_stock_url(@user_stock), params: { user_stock: { stock: @user_stock.stock, user_id: @user_stock.user_id } }
